<template>
  <div class="shop-heading-section" style="background:none;">
    ...
    <div class="shop-info-wrapper">
      <h1 class="shop-name" style="font-size:25px;">{{ shopName }}</h1>
      <div class="shop-meta">
...
const props = defineProps({
  shopLogo: {
    type: String,
    default: 'https://images.unsplash.com/photo-1559056199-641a0ac8b55e?w=200&q=80'
  },
  shopName: {
    type: String,
    default: 'Bean Origin Roastery'
  },
  rating: {
    type: [String, Number],
    default: '4.8'
